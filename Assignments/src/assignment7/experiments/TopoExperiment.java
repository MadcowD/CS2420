 ...
 *
 */
public class TopoExperiment extends Process {
	private Graph data;
	 ...
	 */
	public TopoExperiment(boolean densityGrowth){
	...
	/***
	 * Runs the topological sort experiment.
	 */
	@Override
	public void run (int n, TimeComplexity complexity) {
		GraphUtil.topologicalSort(data);
	}

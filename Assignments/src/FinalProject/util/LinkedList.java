...
public class LinkedList<E> implements Collection<E>
{
	...
	public String toString(){
		...
		{
			Node index = LinkedList.this.head;
			boolean removedNext;
		   
			public LinkedListIterator()
			{
				index = LinkedList.this.head;//not zero because the first element to be returned is data[0]
			...
			{
				return index.next != tail && index.next != null;

...
public abstract class Process{
	 ...
	 * @return IMPORTANT: IF RETURN VALUE IS NON ZERO, DOES NOT TIME EXPERIMENT, RECORDS DATA FROM RUN.
	 */
	public abstract long run(int n, TimeComplexity complexity);

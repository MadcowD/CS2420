 ...
 * @author William Guss
 * Our experiment for the add method, testing both Javas TreeSet and our BST, using balanced trees and unbalanced trees created by sorted lists.
 */
public class BalanceAddExperiment {
	
	
	
	public class JavaExperiment extends Process {
	...
	public class BSTExperiment extends Process {
		List<Integer> data = new ArrayList<Integer>();
